...
const copy = {
  en: {
    ...
    exportLimit: 'Free PDF export limit reached (max. 5). Contact the administrator if you need a higher plan.',
  ...
  id: {
    ...
    exportLimit: 'Batas export PDF untuk paket Free sudah tercapai (maks. 5x). Hubungi administrator jika membutuhkan paket yang lebih tinggi.',
