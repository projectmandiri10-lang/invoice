...
const copy = {
  en: {
    ...
    body: 'Please verify your email, then wait for the administrator to activate your account.',
  ...
  id: {
    ...
    body: 'Silakan verifikasi email Anda terlebih dahulu, lalu tunggu administrator mengaktifkan akun Anda.',
